...
helped usher in the Modern PC era we enjoy today. The 6502 also comes from an
era where assembly programming was necessary for fast, responsive programs.
...
* Readable as a 6502 introduction for someone with or without a copy of [CLHS](http://www.lispworks.com/documentation/HyperSpec/front/).
...
to do with the choice of language than with the emphasis on readable code. My
naivete about how to write an emulator also bears some responsibility. That said,
I plan to get performance more in line with lib6502 and believe it can be done
without damaging the pedagogical aims of the project.
...
* It supports several [paradigms](http://en.wikipedia.org/wiki/Programming_Paradigm)
and good facilities to describe low-level behavior.
...
* functions to have the CPU run a single instruction or run until the program halts.
...
* Addressing Modes as Generic Functions (methods) on unique symbols.
